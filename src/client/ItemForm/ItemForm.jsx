...
const ItemForm = ({ changeHandler, submitClickHandler }) => {
    ...
    return (
        <div className="item-form__container flex flex-col w-full justify-around items-center">
                ...
                <button type="button" onClick={submitClickHandler} className="bg-blue-500 hover:bg-blue-700 text-white uppercase tracking-widest text-md py-2 px-4 rounded mt-3">Add to List</button>
